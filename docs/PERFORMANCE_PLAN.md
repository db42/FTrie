...
Cross-engine comparison plan (Rust vs Elasticsearch): see `docs/ES_BENCHMARK_PLAN.md`.

## Current Benchmark Baseline

Track results via `bench/results/*.json` and compare runs with:

```bash
python3 bench/bench.py compare runA.json runB.json
```
