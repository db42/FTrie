...
echo "    127.0.0.1:${LB_PORT} ftrie.PrefixMatcher/PutWord"
echo ""
...
echo "  grpcurl -plaintext -import-path ./proto -proto ftrie.proto \\"
echo "    -d '${HELLO_REQ}' \\"
echo "    127.0.0.1:${N1_PORT} ftrie.PrefixMatcher/GetPrefixMatch"
echo ""
echo "  grpcurl -plaintext -import-path ./proto -proto ftrie.proto \\"
echo "    -d '${HELLO_REQ}' \\"
echo "    127.0.0.1:${N2_PORT} ftrie.PrefixMatcher/GetPrefixMatch"
echo ""
echo "  grpcurl -plaintext -import-path ./proto -proto ftrie.proto \\"
echo "    -d '${HELLO_REQ}' \\"
echo "    127.0.0.1:${N3_PORT} ftrie.PrefixMatcher/GetPrefixMatch"
echo ""
echo "Try leader redirection (send PutWord to a follower directly):"
echo "  grpcurl -plaintext -import-path ./proto -proto ftrie.proto \\"
echo "    -d '{\"word\":\"jokerraft2\",\"tenant\":\"power\"}' \\"
echo "    127.0.0.1:${N2_PORT} ftrie.PrefixMatcher/PutWord"
echo ""
echo "Failure test:"
echo "  kill $PID_N2"
